...
Creates a new `ItemResponse` for this text item based on the provided answer to the question.
...
Sets the data validation for this text item. Passing in null or a validation lacking requirement functions removes any prior validation.
