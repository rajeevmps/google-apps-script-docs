...
A notes master in a presentation. Read-only.

"A notes master in a presentation. Notes masters define the default text styles and page elements for all notes pages. Notes masters are read-only."
